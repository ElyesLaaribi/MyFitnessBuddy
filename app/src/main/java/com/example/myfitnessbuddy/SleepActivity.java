            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (selectedTabPosition) {
                    case 0:
                        ...
                        break;
                    case 1:
                        intent = new Intent(SleepActivity.this, FoodActivity.class);
                        break;
                    case 2:
                        intent = new Intent(SleepActivity.this, StepsActivity.class);
                        break;
                    case 3:
                        intent = new Intent(SleepActivity.this, SleepActivity.class);
                        break;
                    case 4:
                        intent = new Intent(SleepActivity.this, ExercisesActivity.class);
                        break;
                }
                if (intent != null) {
